...
#region unversioned data builders
/// @func	DataBuilder()
/// @desc	A builder pattern implementation for a "data" member
...
#region versioned data builders
/// @func	VersionedDataBuilder()
/// @desc	A builder pattern implementation for a "data" member, savegame aware versioned
function VersionedDataBuilder() : VersionedDataStruct() constructor {
	construct(VersionedDataBuilder);
...
/// @func	VersionedBindableDataBuilder()
/// @desc	Same as a DataBuilder but the data struct is a Bindable(), savegame aware versioned
function VersionedBindableDataBuilder() : VersionedDataBuilder() constructor {
	construct(VersionedBindableDataBuilder);
