...
Function FindSubstring
    Exch $1    ; Substring (gesuchter Pfad)
    Exch       ; Stack-Puffer bereinigen
    Exch $0    ; Originalstring (kompletter PATH)
...
Function CustomPageCreate
    ...
    ; Checkbox erstellen
    ${NSD_CreateCheckbox} 20u 20u 200u 12u "Add to PATH (MUST BE ACTIVE on first install!)"
    Pop $AddToPathCheckbox

    ; Checkbox standardmäßig aktivieren (optional)
    ${NSD_SetState} $AddToPathCheckbox 1

    nsDialogs::Show
FunctionEnd

Function CustomPageLeave
	SetRegView 64    ; Setzt die Registry-Ansicht auf 64-Bit
    ${NSD_GetState} $AddToPathCheckbox $0
    StrCmp $0 1 0 End
	
	; Aktuellen PATH-Wert aus der Registry lesen
	ReadRegStr $0 HKLM "SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "Path"

    ; Installationspfad in Großbuchstaben für Vergleich
    StrCpy $1 "$INSTDIR"
    System::Call 'Kernel32::CharUpperBuff(t r1, i ${NSIS_MAX_STRLEN})'
    System::Call 'Kernel32::CharUpperBuff(t r0, i ${NSIS_MAX_STRLEN})'

    ; Überprüfen, ob der Installationspfad schon im PATH steht
    Push $0
    Push $1
    Call FindSubstring
    Pop $2
    ...
    StrCmp $2 1 0 End  ; Wenn 1 zurückkommt, ist der Pfad schon vorhanden
	
	StrCpy $0 "$0;$INSTDIR"
	WriteRegExpandStr HKLM "SYSTEM\CurrentControlSet\Control\Session Manager\Environment" "Path" "$0"
	
	; Registrierung aktualisieren, damit die Änderung sofort wirksam wird
	System::Call 'Kernel32::SendMessageTimeoutA(i 0xffff, i ${WM_SETTINGCHANGE}, i 0, t "Environment", i 0, i 5000, *i .r1)'
...
Section "Start Menu Shortcuts"
    ...
    ;Checkbox ${DEFAULT_CHECKED} "Add ${PRODUCT_NAME} to the system PATH variable" ${AddToPathCheckbox}
