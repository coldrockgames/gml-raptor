...
// - RaptorFrameFormatter:  Precedes each log line with the current game frame number. 
//							Very useful for exact timing.
//                          With this formatter you can see the exact frame, when a line was written. 
//							This is the default.
// - RaptorTimeFormatter:   Instead of the game frame, this formatter precedes each line with the
//							current_time, which is a milliseconds value since the game was started. 
//							This is less exact than the RaptorFrameFormatter.
...
//
// A note on verbose logging (level 0): This logs every single mouse_enter/leave event, 
// each tooltip shown, everything!
...
// To avoid, that you "forget" to turn a module off, by default there's a set of these macros, 
// where every log is disabled for release mode
